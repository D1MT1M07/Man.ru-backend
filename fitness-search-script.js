/**
 * Fitness Page Search Script
 * Поиск только по статьям категории "Фитнес"
 */

class FitnessSearchManager {
    constructor() {
    ...
    performSearch(query) {
        ...
        // Ищем только в статьях категории "Фитнес"
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.fitnessSearchManager = new FitnessSearchManager();
});
