/**
 * Relations Page Search Script
 * Поиск только по статьям категории "Отношения"
 */

class RelationsSearchManager {
    constructor() {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.relationsSearchManager = new RelationsSearchManager();
});
